            ...
            steps {
                script {
                    ...
                    if (fileExists(backendPath)) {
                        ...
                        bat "docker tag ${backendImage} radhikasharma5047/fullstack-backend:fullstack-backend" // Tag image
                    } else {
            ...
            steps {
                script {
                    ...
                    if (fileExists(frontendPath)) {
                        ...
                        bat "docker tag ${frontendImage} radhikasharma5047/fullstack-frontend:fullstack-frontend" // Tag image
                    } else {
            ...
            steps {
                script {
                    ...
                    docker.withRegistry(dockerRegistry, "dockerhub-credentials") {
                        bat "docker push radhikasharma5047/fullstack-backend:${backendImage}"
                    }
                }
            }
        }
        ...
        stage('Push Frontend') {
            steps {
                script {
                    ...
                    docker.withRegistry(dockerRegistry, "dockerhub-credentials") {
                        bat "docker push radhikasharma5047/fullstack-frontend:${frontendImage}"
                    }
                }
            }
        }
