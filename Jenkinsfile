pipeline {
    ...
    stages {
         ...
         stage('Check .env File') {
            steps {
                script {
                    def envFilePath = 'C://ProgramData//Jenkins//.jenkins//workspace//MERN-PROJECT//backend//.env'
            ...
            steps {
                script {
                    ...
                    if (fileExists(backendPath)) {
                        ...
                        bat "docker tag ${backendImage} subh21/fullstack-backend:fullstack-backend" // Tag image
                    } else {
            ...
            steps {
                script {
                    ...
                    if (fileExists(frontendPath)) {
                        ...
                        bat "docker tag ${frontendImage} subh21/fullstack-frontend:fullstack-frontend" // Tag image
                    } else {
            ...
            steps {
                script {
                    ...
                    docker.withRegistry(dockerRegistry, "dockerhub-credentials") {
                        bat "docker push subh21/fullstack-backend:${backendImage}"
                    }
                }
            }
        }
        ...
        stage('Push Frontend') {
            steps {
                script {
                    ...
                    docker.withRegistry(dockerRegistry, "dockerhub-credentials") {
                        bat "docker push subh21/fullstack-frontend:${frontendImage}"
                    }
                }
            }
        }
