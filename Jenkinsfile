            ...
            steps {
                script {
                    ...
                    if (fileExists(backendPath)) {
                        ...
                        bat "docker tag ${backendImage}:latest harshvashishth12/${backendImage}:latest" // Tag image
                    } else {
            ...
            steps {
                script {
                    ...
                    if (fileExists(frontendPath)) {
                        ...
                        bat "docker tag ${frontendImage}:latest harshvashishth12/${frontendImage}:latest" // Tag image
                    } else {
