            ...
            steps {
                script {
                    ...
                    if (fileExists(backendPath)) {
                        ...
                        bat "docker tag ${backendImage}:latest shakeel14/${backendImage}:latest" // Tag image
                    } else {
            ...
            steps {
                script {
                    ...
                    if (fileExists(frontendPath)) {
                        ...
                        bat "docker tag ${frontendImage}:latest shakeel14/${frontendImage}:latest" // Tag image
                    } else {
            ...
            steps {
                script {
                    ...
                    docker.withRegistry(dockerRegistry, dockerCreds) {
                        bat "docker push shakeel14/${backendImage}:latest"
                    }
                }
            }
        }
        ...
        stage('Push Frontend') {
            steps {
                script {
                    ...
                    docker.withRegistry(dockerRegistry, dockerCreds) {
                        bat "docker push shakeel14/${frontendImage}:latest"
                    }
                }
            }
        }
